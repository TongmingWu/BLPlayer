...
public class BannerLayout extends RelativeLayout {
    ...
    private int imageScaleType = ScaleType.FIT_XY.ordinal();
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        imageScaleType = array.getInt(R.styleable.BannerLayoutStyle_imageScaleType, ScaleType.FIT_XY.ordinal());
     ...
     * @return
     */
    private ImageView.ScaleType getScaleType(int imageScaleType) {
        if (ScaleType.MATRIX.ordinal() == imageScaleType) {
            return ImageView.ScaleType.MATRIX;
        } else if (ScaleType.FIT_XY.ordinal() == imageScaleType) {
            return ImageView.ScaleType.FIT_XY;
        } else if (ScaleType.FIT_START.ordinal() == imageScaleType) {
            return ImageView.ScaleType.FIT_START;
        } else if (ScaleType.FIT_CENTER.ordinal() == imageScaleType) {
            return ImageView.ScaleType.FIT_CENTER;
        } else if (ScaleType.FIT_END.ordinal() == imageScaleType) {
            return ImageView.ScaleType.FIT_END;
        } else if (ScaleType.CENTER.ordinal() == imageScaleType) {
            return ImageView.ScaleType.CENTER;
        } else if (ScaleType.CENTER_CROP.ordinal() == imageScaleType) {
            return ImageView.ScaleType.CENTER_CROP;
        } else if (ScaleType.CENTER_INSIDE.ordinal() == imageScaleType) {
